...
INSERT INTO `inventory` VALUES ('San Fransisco','iPhone','6s',50),('San Fransisco','iPhone','7',10),('San Fransisco','iPhone','X',200),('San Fransisco','Samsung','Galaxy S',200),('San Fransisco','Samsung','Note 8',100),('San Jose','iPhone','6s',100),('San Jose','iPhone','7',50),('San Jose','iPhone','X',150),('San Jose','Samsung','Galaxy S',200),('San Jose','Samsung','Note 8',150);
...
--
-- Table structure for table `sales_organization`
--
...
CREATE TABLE `sales_organization` (
  ...
  `sales_org` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`sales_org_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sales_organization`
--

LOCK TABLES `sales_organization` WRITE;
/*!40000 ALTER TABLE `sales_organization` DISABLE KEYS */;
INSERT INTO `sales_organization` VALUES (1,'Domestic'),(2,'Export');
/*!40000 ALTER TABLE `sales_organization` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'sqltutorial'
--
...
-- Dump completed on 2023-12-25 22:54:08
