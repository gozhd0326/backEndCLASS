...
public interface UserRepository extends JpaRepository<User, Long> {
	 @EntityGraph(attributePaths = "authorities") // @EntityGraph는 미리 캐싱 해놓는 개념임(메모리를 효율적으로 사용하기 위해!) 해당 테이블로 이동할 수 있는 길(Paths)(연결고리)
	...
	Optional<User> findByUsername(String x);
